...
public class ConversionServer {
	...
	public static void main(String[] args) {
		try {
			LocateRegistry.createRegistry(1099); /*Démarrage de l’annuaire RMI dans le serveur en utilisant le port 1099, 
			il va sauvegarder les objets et leurs ref*/
			...
			// od c celui qui va preparer le stub et le donne au client qui va connecté 
